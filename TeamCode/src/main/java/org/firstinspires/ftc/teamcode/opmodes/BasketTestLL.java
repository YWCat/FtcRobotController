...
public class BasketTestLL extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        Action bskToFst = drive.actionBuilder(drive.pose)
                .splineToLinearHeading(sample1Pose, Math.PI)
                .build();
        Action armToIntakePrep = rotatingSlide.arm.getArmToPosition(RotatingSlide.ARM_INTAKE_DEG-12, true);
        Action armToIntake = rotatingSlide.arm.getArmToPosition(RotatingSlide.ARM_INTAKE_DEG, true);
        Action intakeSlide = rotatingSlide.slide.getSlideToPosition(RotatingSlide.SLIDE_RETRACT_IN+7, 1, true);
        ...
        //drive.setCamCorr(true, 1, 1, 0,-7, 1);
        Actions.runBlocking(
                new SequentialAction(
                        new ParallelAction(
                                bskToFst,
        ...
        armToIntake = rotatingSlide.arm.getArmToPosition(RotatingSlide.ARM_INTAKE_DEG, true);
        intakeSlide = rotatingSlide.slide.getSlideToPosition(RotatingSlide.SLIDE_RETRACT_IN+7, 1, true);
        ...
        armToIntakePrep = rotatingSlide.arm.getArmToPosition(RotatingSlide.ARM_INTAKE_DEG-12, true);
        armToIntake = rotatingSlide.arm.getArmToPosition(RotatingSlide.ARM_INTAKE_DEG, true);
        intakeSlide = rotatingSlide.slide.getSlideToPosition(RotatingSlide.SLIDE_RETRACT_IN, 1, true);
        wristIntake = sampleIntake.getTurnWristAction(SampleIntakeClaw.WRIST_INTAKE_CLAW, true);
        closeClaw = sampleIntake.getMoveClawAction(true, true);
        Actions.runBlocking(
                new SequentialAction(
        ...
        drive.setCamCorr(true, 1, 1,-3, -13, 2);
        drive.alignByCam(true);
        drive.alignByCam(false);
        drive.disCamCorr();
        /*
        ...
        Action toAscend = drive.actionBuilder(drive.pose)
                ...
                .splineToLinearHeading(new Pose2d(pos_multiplier*18,pos_multiplier*(0),0), 0)
                .build();
        armToIntake = rotatingSlide.arm.getArmToPosition(RotatingSlide.ARM_INTAKE_DEG-90, true);
        intakeSlide = rotatingSlide.slide.getSlideToPosition(RotatingSlide.SLIDE_RETRACT_IN, 1, true);
        wristIntake = sampleIntake.getTurnWristAction(SampleIntakeClaw.WRIST_INTAKE_CLAW, true);
        closeClaw = sampleIntake.getMoveClawAction(true, true);
        Actions.runBlocking(
